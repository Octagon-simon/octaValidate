    ...
    if(validate){
        ...
        formInputs.forEach(input => {
            ...
            if(validate[formInputId]){
                ...
                if(continueValidation && (item ==='EMAIL' || type == 'email')){
                ...
                if(continueValidation && item === 'ALPHA_ONLY'){
                ...
                if(continueValidation && item === 'ALPHA_SPACES'){
                ...
                if(continueValidation && item === 'ALPHA_NUMERIC'){
                ...
                if(continueValidation && item === 'LOWER_ALPHA'){
                ...
                if(continueValidation && item === 'UPPER_ALPHA'){
                ...
                if(continueValidation && item === 'PWD'){
                ...
                if(continueValidation && (item === 'DIGITS' || type == 'number')){
                    if(isNaN(elem.value)) {
                        errors++;
                ...
                if(continueValidation && (item === 'URL' || type == 'url')){
                ...
                if(continueValidation && item === 'URL_QP'){
                ...
                if(continueValidation && item === 'DATE_MDY'){
                ...
                if(continueValidation && item === 'USERNAME'){
